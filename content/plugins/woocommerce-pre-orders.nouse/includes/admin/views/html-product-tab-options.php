...
<div id="wc_pre_orders_data" class="panel woocommerce_options_panel">
	<div class="options_group">
		...
		if ( $has_active_pre_orders = WC_Pre_Orders_Product::product_has_active_pre_orders( $post->ID ) ) {
			echo '<p><strong>' . sprintf( __( 'There are active pre-orders for this product. To change these settings, please %scomplete or cancel the active pre-orders%s first.', 'wc-pre-orders' ), '<a href="' . admin_url( 'admin.php?page=wc_pre_orders' ) . '">', '</a>' ) . '</strong></p>';
		}
