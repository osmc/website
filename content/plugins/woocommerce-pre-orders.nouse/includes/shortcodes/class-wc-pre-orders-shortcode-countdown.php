 ...
 *
 * @package     WC-Pre-Orders/Shortcodes
 * @author      WooThemes
...
class WC_Pre_Orders_Shortcode_Countdown {
	...
	public static function output( $atts ) {
		...
		extract( shortcode_atts( array(
			...
			'before'      => '',
			'after'       => '',
			'layout'      => '{y<}{yn} {yl}{y>} {o<}{on} {ol}{o>} {d<}{dn} {dl}{d>} {hn} {hl} {mn} {ml} {sn} {sl}',
			'format'      => 'yodHMS',
			'compact'     => 'false',
		), $atts ) );
	...
	private static function enqueue_scripts() {
		...
		if ( WPLANG ) {
			...
			if ( $localization )
				wp_enqueue_script( 'jquery-countdown-' . $localization, $wc_pre_orders->get_plugin_url() . '/assets/js/jquery.countdown/jquery.countdown-' . $localization . '.js', array( 'jquery-countdown' ), '1.6.1' );
		}
	}
}
